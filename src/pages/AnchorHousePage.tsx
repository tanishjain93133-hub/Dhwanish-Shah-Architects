...
export const AnchorHousePage: React.FC = () => {
  ...
  return (
    <div className="bg-obsidian min-h-screen text-white">
      <SEO 
        title="Anchor House Review | Residential Project by DSA"
        description="Read client feedback and explore the luxury residential design and execution journey of Anchor House by Dhwanish Shah Architects."
      />
      <Navbar />
