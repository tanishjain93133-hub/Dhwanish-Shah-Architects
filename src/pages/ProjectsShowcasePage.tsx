...
import Hero from "../components/ShowcaseHero";
...
export const ProjectsShowcasePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans antialiased text-zinc-900 select-none no-scrollbar">
      <SEO 
        title="Our Projects | Luxury Showcase by Dhwanish Shah Architects"
        description="View our signature 3D Dome Gallery and luxury residential and commercial architecture projects showcase."
      />
      <Navbar />
