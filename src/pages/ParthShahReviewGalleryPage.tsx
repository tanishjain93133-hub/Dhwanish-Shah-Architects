...
export const ParthShahReviewGalleryPage: React.FC = () => {
  ...
  return (
    <div className="bg-obsidian min-h-screen text-white">
      <SEO 
        title="Parth Shah Client Review | Dhwanish Shah Architects"
        description="Read the client feedback and review gallery of Ar. Parth Shah's residence designed by Dhwanish Shah Architects."
      />
      <Navbar />
