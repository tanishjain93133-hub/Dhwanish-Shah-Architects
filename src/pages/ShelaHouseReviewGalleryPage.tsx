...
export const ShelaHouseReviewGalleryPage: React.FC = () => {
  ...
  return (
    <div className="bg-obsidian min-h-screen text-white">
      <SEO 
        title="Shela House Client Review | Dhwanish Shah Architects"
        description="Read the client feedback and review gallery of Shela House residential design by Dhwanish Shah Architects."
      />
      <Navbar />
